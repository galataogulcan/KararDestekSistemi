...
<head>
    ...
    <link href="harita2.css" rel="stylesheet">
...
<body>
    ...
    <div class="content">
        ...
        <div class="main">
            <div class="nav">
                <span class="dash">Yangın Risk Haritası</span>
                <div class="navigation">
                    <i class="fas fa-tachometer-alt"></i>
                    <span>Home</span>
                    <span>></span>
                    <span>Yangın Risk Haritası</span>
                </div>
            </div>
        ...
        <div class="boxes">
            <div class="box1">
            <div class="text">İl Bazlı Orman Yangını Risk Haritası<br /></div>
                <span>(1 En Yüksek -  5 En Düşük)</span>
  ...
  var dataSet = anychart.data.set(
      [
        ...
        <?php
        $sql = "SELECT iller.il_id, iller.yangin_derece FROM iller";
        $result = mysqli_query($mysqli, $sql);
                ...
                while ($row = mysqli_fetch_array($result)) {
                    echo "{'id'",":","'".$row['il_id']."','value'",":".$row['yangin_derece']."},";
                }
  ...
  series.colorScale(anychart.scales.linearColor('#801c1c', '#f7e6e6'));
